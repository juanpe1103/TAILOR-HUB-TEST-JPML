...
import imgLogin from "@/../public/MEDIA/restauranteDeLujilloLogin.png";
import imgRegistro from "@/../public/MEDIA/restauranteDeLujilloRegistro.png";
        ...
        <div className="grid md:grid-cols-2 gap-8 items-end">
            ...
            <div className="bg-[#1E40FF] text-white px-8 py-6 rounded-[20px] flex flex-col shadow-xl">
                ...
                <div className="text-3xl font-bold flex items-center mb-4">
                    <Image src={logo} alt="logo" className="w-12 h-12" /> <span className="tracking-tight">tailor</span>
                </div>
            ...
            <div className="relative rounded-[20px] shadow-xl overflow-hidden min-h-[600px]">
                <Image
                    src={mode === "login" ? imgLogin : imgRegistro}
                    alt="Restaurant"
                    fill
